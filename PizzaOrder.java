   ...
   public static void main (String[] args)
   {
     ...
     else if(inches == 16)
     {
    	 cost = 16.99;
      	...
      	System.out.println("User did not choose the following choices, so a 12 inch pizza will be made.");
      ...
      case 'd':
    	  ...
    	  break;
    	  default:
    		  System.out.println("User did not select any of the following choices,"
    		  						+ " therefore hand-tossed will be made");
      }
